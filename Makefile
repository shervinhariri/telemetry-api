...
pull:
	...
	@IMAGE_REPO=$${IMAGE_REPO:-shvin/telemetry-api} IMAGE_TAG=$${IMAGE_TAG:-v0.8.7-golden} docker compose -f docker-compose.yml -f compose.override.yml pull
...
help:
	...
	@echo ""
	@echo "Usage examples:"
	@echo "  make repro                    # Default: shvin/telemetry-api:v0.8.7-golden"
